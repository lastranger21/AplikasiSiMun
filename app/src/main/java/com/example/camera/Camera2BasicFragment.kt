...
import com.google.tflite.imageclassification.sample.camera.AutoFitTextureView
import com.google.tflite.imageclassification.sample.camera.CompareSizesByArea
import com.google.tflite.imageclassification.sample.camera.PIC_FILE_NAME
import com.google.tflite.imageclassification.sample.camera.REQUEST_CAMERA_PERMISSION
...
class Camera2BasicFragment : Fragment(), View.OnClickListener,
    ...
    val listtidakpenting = listOf("botol air","towel","socks","gelas plastik","lampu tenda","outdoor,sandals","hat","cap","headlamp climbing")
    val readertidakpenting = File("assets/labeltidakpenting.txt")
...
//                LOGGER.d("Initializing buffer %d at size %d", i, buffer.capacity())
 ...
 fun updateDetail() {
    val intent = Intent(activity, EquipmentActivity::class.java)
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        rl = view.findViewById(R.id.control);
        //confidenceTextView = view.findViewById(R.id.tv_confidence)
        textureView = view.findViewById(R.id.texture)
        buttoneq = view.findViewById(R.id.ib_camtoequ)
        buttoneq.setOnClickListener { updateDetail() }
    }
...
//            LOGGER.i("Opening camera preview: " + previewSize.width + "x" + previewSize.height)
    ...
    override fun onClick(view: View) {
        when (view.id) {
            androidx.appcompat.R.id.message-> {
            ...
            try {
                ...
                if (isProcessingFrame) {
                    ...
                    activity?.runOnUiThread({
                        ...
                        //results?.get(0)?.title=="botol air"
                        if(listtidakpenting.contains(results?.get(0)?.title)){
